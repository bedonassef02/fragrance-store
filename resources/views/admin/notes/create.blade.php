...
<div class="flex items-center justify-between">
    <div>
        <h1 class="text-3xl font-bold text-white tracking-tight font-display">New Note</h1>
        <p class="text-moon-gray-400 mt-1">Add a new olfactory note to the library.</p>
    </div>
</div>
@endsection

@section('content')
<form action="{{ route('admin.notes.store') }}" method="POST" enctype="multipart/form-data" class="max-w-2xl mx-auto">
    @csrf
        ...
        <div class="bg-moon-dark/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Bergamot"
                ...
                <div>
                    ...
                    <select name="type" id="type" required
                        ...
                        <option value="general">General / Unclassified</option>
