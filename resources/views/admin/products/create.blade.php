...
<div class="flex items-center justify-between">
    <div>
        ...
        <p class="text-moon-gray-400 mt-1">Add a new item to your catalog.</p>
    </div>
            ...
            <div class="bg-moon-dark/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Premium Cotton T-Shirt"
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" required placeholder="Describe your product..."
             ...
             <div class="bg-moon-dark/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl">
                 ...
                 <div class="space-y-4">
                     <div>
                        ...
                        <input type="text" name="badge" id="badge" value="{{ old('badge') }}" placeholder="e.g. New Arrival"
             ...
             <div class="bg-moon-dark/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl">
                 ...
                 <div class="space-y-4">
                     <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" placeholder="Custom title for search engines"
                               class="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 text-white placeholder-moon-gray-500 focus:border-moon-gold focus:ring-1 focus:ring-moon-gold transition-all">
                ...
                div.innerHTML = `
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-2 text-xs">
                             ...
                             <select name="images[${currentIndex}][color_id]" class="w-full md:w-48 bg-black/20 border border-white/10 rounded-lg px-2 py-1 text-moon-gray-300 text-xs focus:border-moon-gold focus:ring-0">
