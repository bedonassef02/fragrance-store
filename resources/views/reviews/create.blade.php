                    ...
                    <div class="flex-1 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex flex-row-reverse justify-end gap-2 group">
                                @for($i = 5; $i >= 1; $i--)
                                <input type="radio" name="reviews[{{ $product->id }}][rating]" id="rating-{{ $product->id }}-{{ $i }}" value="{{ $i }}" class="peer hidden" required>
                                <label for="rating-{{ $product->id }}-{{ $i }}" class="text-gray-600 cursor-pointer peer-checked:text-moon-gold hover:text-moon-gold hover:!text-moon-gold peer-checked:group-[]:text-moon-gold transition-colors">
